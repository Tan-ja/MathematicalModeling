...
public interface TeamInfoService {
	// 添加团队
	boolean addTeamInfo(TeamInfo teaminfo);
	// 根据队长id删除团队
	boolean deleteTeamInfoByCaptainId(Integer id);
	// 修改参赛人的相关信息
	boolean updateStunum(TeamInfo teaminfo);
	// 根据队长id查找相应的队伍
	...
	// 修改某个队伍的当前状态
	boolean updateTeamCurrentStatusByMatchIdAndCapIdAndCurrentStatus(Integer matchid, Integer capid, int currentstatus);
	// 管理员动态查询队伍审核
