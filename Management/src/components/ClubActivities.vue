        ...
        <div style="width:1500px;heigth:100%;margin: 0 auto" v-show="!isDesc">
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>学术动态管理</el-breadcrumb-item>
                    <el-breadcrumb-item>社团活动</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=社团活动&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
            ...
            toAddHonor(){
                sessionStorage.addcate = "社团活动";
                // this.$cookie.set("addcate", "学术资讯");
