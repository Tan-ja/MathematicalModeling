        ...
        <div style="width:1500px;heigth:100%;margin: 0 auto" v-show="!isDesc">
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>协会荣誉</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=协会荣誉&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
            ...
            toAddHonor(){
                sessionStorage.addcate = "协会荣誉";
                // this.$cookie.set("addcate", "协会荣誉");
