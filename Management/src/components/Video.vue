        ...
        <div style="width:1500px;heigth:100%;margin: 0 auto" v-show="!isDesc">
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>协会发展管理</el-breadcrumb-item>
                    <el-breadcrumb-item>宣传视频</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=宣传视频&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
            ...
            toAddHonor(){
                sessionStorage.addcate = "宣传视频";
                // this.$cookie.set("addcate", "宣传视频");
