        ...
        <div style="width:1500px;heigth:100%;margin: 0 auto" v-show="!isDesc">
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>竞赛成绩</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=竞赛成绩&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
            ...
            toAddHonor(){
                sessionStorage.addcate = "竞赛成绩";
                // this.$cookie.set("addcate", "竞赛成绩");
