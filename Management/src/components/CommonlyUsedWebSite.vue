        ...
        <div style="width:1500px;heigth:100%;margin: 0 auto" v-show="!isDesc">
            <div>
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>常用软件</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=常用软件&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
            ...
            toAddHonor(){
                sessionStorage.addcate = "常用软件";
                // this.$cookie.set("addcate", "常用软件");
