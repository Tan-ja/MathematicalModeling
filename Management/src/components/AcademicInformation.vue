    ...
    export default {
        ...
        methods:{
            async getDataByFuzzyQuery(){
                const result = await this.$axios.get("/academic/allfuzzyquery?acategory=学术资讯&currentPage="+this.currentPage+"&pageSize="+this.pageSize+"&key="+this.search);
